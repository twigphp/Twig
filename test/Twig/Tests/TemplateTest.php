...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCallUnknownMacro()
    {
        ...
        $template->publicCallMacro(new Twig_Tests_TemplateWithMacros('my/template'), 'foo', array());
    }
}
...
class Twig_TemplateTest extends Twig_Template
{
    ...
    public function publicCallMacro(Twig_Template $template, $macro, array $arguments)
    {
