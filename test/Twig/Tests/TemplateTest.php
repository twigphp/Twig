...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getAttributeExceptions()
    {
        $tests = array(
            ...
            array('{{ empty_array["a"] }}', 'Impossible to access a key "a" on an empty array in "%s" at line 1', false),
    ...
    public function getGetAttributeTests()
    {
        ...
        $tests = array_merge($tests, array(
            ...
            array(false, null, array(), 'a', array(), $anyType, false, 'Impossible to access a key "a" on an empty array'),
        ));
