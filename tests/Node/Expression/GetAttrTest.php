...
class GetAttrTest extends ASTNodeTestCase
{
    ...
    public static function getTests()
    {
        ...
        $tests[] = [$node, sprintf('%s%s, "bar", [], "any", false, false, false, 1)', self::getAttributeGetter(), self::getVariableGetter('foo', 1))];
        ...
        $tests[] = [$node, sprintf('%s%s, "bar", [0 => %s, 1 => "bar"], "method", false, false, false, 1)', self::getAttributeGetter(), self::getVariableGetter('foo', 1), self::getVariableGetter('foo'))];
