...
if (version_compare(PHP_VERSION, '5.4.0', '<')) {
     ...
     */
    public function twig_urlencode_filter($url, $raw = false)
    {
        if (is_array($url)) {
     ...
     *
     * @param string|array $url A string or an array of query string parameters to be URL encoded
     * @param bool         $raw true to use rawurlencode() instead of urlencode for strings. When $url is an array, then encoding is performed according to RFC 3986, and spaces will be percent encoded (%20).
     *
     * @return string The URL encoded value
     */
    public function twig_urlencode_filter($url, $raw = false)
