...
class Lexer
{
    ...
    public function __construct(Environment $env, array $options = [])
    {
        ...
        $this->regexes = [
            ...
            'lex_block_raw' => '/\s*verbatim\s*(?:(?:'.preg_quote($this->options['whitespace_trim'], '/').'|'.preg_quote($this->options['whitespace_line_trim'], '/').')'.preg_quote($this->options['tag_block'][1], '/').'\s*|\s*'.preg_quote($this->options['tag_block'][1], '/').')/As',
