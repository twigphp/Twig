...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters(): array
    {
        return [
            ...
            new TwigFilter('format', self::sprintf(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('replace', self::replace(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('number_format', $this->formatNumber(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('abs', 'abs', ['always_allowed_in_sandbox' => true]),
            new TwigFilter('round', self::round(...), ['always_allowed_in_sandbox' => true]),

            // encoding
            new TwigFilter('url_encode', self::urlencode(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', self::convertEncoding(...), ['always_allowed_in_sandbox' => true]),

            // string filters
            new TwigFilter('title', self::titleCase(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('capitalize', self::capitalize(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('upper', self::upper(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('lower', self::lower(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('striptags', self::striptags(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('trim', self::trim(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('nl2br', self::nl2br(...), ['pre_escape' => 'html', 'is_safe' => ['html'], 'always_allowed_in_sandbox' => true]),

            // array helpers
            new TwigFilter('join', self::join(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('split', self::split(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('sort', self::sort(...)),
            new TwigFilter('merge', self::merge(...), ['always_allowed_in_sandbox' => true]),
            new TwigFilter('batch', self::batch(...), ['always_allowed_in_sandbox' => true]),
            ...
            new TwigFilter('reverse', self::reverse(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('shuffle', self::shuffle(...), ['needs_charset' => true]),
            new TwigFilter('length', self::length(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('slice', self::slice(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('first', self::first(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('last', self::last(...), ['needs_charset' => true, 'always_allowed_in_sandbox' => true]),

            // iteration and runtime
            new TwigFilter('default', self::default(...), ['node_class' => DefaultFilter::class, 'always_allowed_in_sandbox' => true]),
            new TwigFilter('keys', self::keys(...), ['always_allowed_in_sandbox' => true]),
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('max', 'max', ['always_allowed_in_sandbox' => true]),
            new TwigFunction('min', 'min', ['always_allowed_in_sandbox' => true]),
            new TwigFunction('range', 'range'),
            new TwigFunction('constant', self::constant(...)),
            new TwigFunction('cycle', self::cycle(...), ['always_allowed_in_sandbox' => true]),
